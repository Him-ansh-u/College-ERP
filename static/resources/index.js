$(document).ready(function(){
  ...
  $("#contact-info").click(function(){
      $("#contact-info-form").slideToggle();
  });
  $("#other-info").click(function(){
      $("#other-info-form").slideToggle();
  });
  $("#address-info").click(function(){
      $("#address-info-form").slideToggle();
  });
});

$(document).ready(function(){
  $("#test-test").click(function(){
      $("#test-panel").slideToggle();
  });
  $("#result").click(function(){
      $("#result-panel").slideToggle();
  });
  $("#admit-card").click(function(){
      $("#admit-card-panel").slideToggle();
  });
...
function getProgram(){
  document.getElementById('general-details').style.display="none";
...
function getResult(){
  ...
  let exam=document.getElementById('exam-select').value;
  let sem=document.getElementById('semester-select').value;
  let program=document.getElementById('program').value;
  if(!exam || !sem || !program){
      document.getElementById('warning-result').style.display="flex";
  }else{
      document.getElementById('download-result-btn').style.display="flex";
...
function getAdmit(){
  ...
  document.getElementById('download-admitcard-btn').style.display="flex";
      document.getElementById('warning-admit').style.display="none";
